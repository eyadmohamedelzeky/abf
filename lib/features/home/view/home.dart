            ...
            child: Container(
              ...
              child: BottomNavigationBar(
                ...
                items: <BottomNavigationBarItem>[
                  ...
                  BottomNavigationBarItem(
                    icon: BlocBuilder<CardController, CardState>(
                      builder: (context, state) {
                          ...
                          children: <Widget>[
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  '${card.cardProductsResponse?.data?.cartProducts?.length ?? 0}',
                  ...
                  BottomNavigationBarItem(
                    icon: Image(
                      ...
                      width: 25,
                      color:
                          getIconColor(2), // Set icon color based on selection
                    ),
                    label: 'مشاريعنا',
                  ),
                  BottomNavigationBarItem(
                    icon: Image(
                      ...
                      width: 25,
                      color:
                          getIconColor(3), // Set icon color based on selection
                    ),
                    label: 'أعمالنا',
                  ),
                  BottomNavigationBarItem(
                    icon: Image(
                      ...
                      width: 25,
                      color:
                          getIconColor(4), // Set icon color based on selection
                    ),
                    label: 'المزيد',
                  ),
                ],
